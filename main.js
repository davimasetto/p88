...
function myKeyDown(e)
{
	...
	if((ballX==holeX)&&(ballY==holeY)){
		...
		document.getElementsById("hd3").innerHTML ="Você atingiu o objetivo!!!";
		...
		if(ballY >=0)
		 {
			...
			console.log("Quando a tecla direcional alto é pressionada, X = " + ball_x + " , Y" + ball_y);
			canvas.remove(ballObj);
			newImage();
		 }
	}
...
//os componentes não estão aparecendo//